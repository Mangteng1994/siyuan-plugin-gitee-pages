...
3. 如需让出链笔记发布为独立页面并在新标签页打开，可开启“出链页面单独跳转”
4. 打开一篇笔记，点击图标 → 一键发布
5. GitHub Pages 等待 1-3 分钟后访问；Gitee Pages 需手动点击「更新」
...
- 可选“出链页面单独跳转”：主文档不再合并出链内容，出链笔记单独生成页面并以新标签页打开
...
│   └── link-icon/             # 若已安装 link-icon，会一并发布图标资源
├── 文档目录/                   # 每篇文档一个子目录
│   ├── index.html
│   └── assets/...             # 图片等关联资源
```
